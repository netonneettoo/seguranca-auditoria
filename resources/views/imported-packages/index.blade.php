		...
		<div class="col-md-12">
            <div class="panel panel-default">
				<div class="panel-heading">
                    Packages
                    {{--<a href="/imported-packages/create" class="btn btn-success pull-right" data-toggle="tooltip" data-placement="left" title="Add">--}}
                        ...
                        <tbody>
                            @foreach($packages as $package)
                                <tr>
                                    ...
                                    <td>{{$package->data}}</td>
                                    <td>
                                        <a href="/imported-packages/{{$package->id}}" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Show">
                                            <span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>
                                        </a>
                                        <a href="/imported-packages/{{$package->id}}/edit" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit">
                                            <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                                        </a>
                                        <form id="form-delete-{{$package->id}}" action="/imported-packages/{{$package->id}}" method="POST" style="display:inline;">
                ...
                <div class="panel-footer">
                    <div class="pull-right">
                        {{--<form id="form-import" style="display:inline;">--}}
                            ...
                            {{--</button>--}}
                        {{--</form>--}}
                        {{--<a href="/imported-packages/export" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Export to TXT">--}}
